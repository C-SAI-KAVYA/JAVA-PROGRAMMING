...
public class StockAccountUsingLinkedListServiceProviderImpl implements StockAccountServiceProvider{
	...
	String transactionFileName = "TransactionInformationUsingLinkedList.json";
